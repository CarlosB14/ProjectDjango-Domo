...
TEMPLATES_DIR = BASE_DIR / "domotica" / "templates"

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-*olh#u#o%wqec$fc0sdx9_+p-#o!+qu&x^+-8^va_(o0d6w4)#'
...
EMAIL_USE_TLS = True
EMAIL_HOST_USER = env('EMAIL_HOST_USER')  # Reemplaza con tu dirección de correo
